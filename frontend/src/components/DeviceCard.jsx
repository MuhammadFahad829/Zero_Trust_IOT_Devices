  ...
  return (
    <div
      className={[
        ...
        compact ? 'p-2.5 rounded-xl flex flex-col justify-between h-full min-w-[200px] max-w-[320px] flex-shrink-0' : 'p-3 rounded-xl',
        isBlocked ? 'border-red-500/40' : 'border-green-500/20',
        device.alert ? 'pulse-red' : '',
      ].join(' ')}
    >
      {isBlocked && <div className="absolute inset-0 border-2 border-red-500/20 rounded-xl pointer-events-none" />}
      ...
      <div className={`flex justify-between items-start ${compact ? 'mb-1.5' : 'mb-2'}`}>
        ...
        <div className="flex-1">
          ...
          <div className={`mt-1.5 flex flex-wrap gap-2 items-center ${compact ? 'text-[11px]' : 'text-[11px]'}`}>
      ...
      <div className={`grid grid-cols-2 gap-2 text-xs ${compact ? 'mb-2 mt-2' : 'mb-2 mt-0'}`}>
      ...
      <div className={`mb-2 flex flex-wrap items-center gap-2 ${compact ? 'text-[10px]' : 'text-[11px]'} text-gray-400`}>
      ...
      {!collapsed && !compact && (
        <div className="mb-2">
          ...
          {openDetails && (
            <div className="mt-2 bg-gray-900/35 border border-gray-700 rounded-lg p-2">
