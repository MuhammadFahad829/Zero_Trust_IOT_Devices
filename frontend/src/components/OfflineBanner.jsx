...
export default function OfflineBanner({ onRetry }) {
  return (
    <div className="fixed left-1/2 -translate-x-1/2 top-4 z-50 max-w-3xl w-[95%]">
      <div className="card-soft flex items-center gap-3 bg-yellow-900/95 border border-yellow-700/60 text-yellow-50 px-3 py-2 shadow">
        ...
        <button
          onClick={onRetry}
          className="btn btn-ghost inline-flex items-center gap-2 px-3 py-1 rounded-md bg-yellow-800/70 hover:bg-yellow-800/90 text-yellow-50 text-sm"
        >
