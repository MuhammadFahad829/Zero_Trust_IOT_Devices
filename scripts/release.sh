...
echo "Release helper"
echo "1) Update CHANGELOG.md with release notes under [Unreleased]"
echo "2) Bump frontend version: npm --prefix frontend version patch"
echo "3) Commit and tag: git add CHANGELOG.md frontend/package.json && git commit -m \"chore(release): x.y.z\" && git tag vX.Y.Z"
